...
class NgxHttpCoreModule final :
	public NgxModule<ngx_http_core_loc_conf_t,ngx_http_core_srv_conf_t,ngx_http_core_main_conf_t>
{
public:
	typedef NgxModule<ngx_http_core_loc_conf_t,
			ngx_http_core_srv_conf_t,
			ngx_http_core_main_conf_t> super_type;
...
public:
	template<typename F>
	void handler(ngx_conf_t* cf,F f) const	//设置内容处理handler
	{
		conf().loc(cf).handler = f;	//获取location配置并设置handler
	}
	template<typename F>
...
class NgxHttpUpstreamModule final:
	public NgxModule<void,ngx_http_upstream_srv_conf_t,ngx_http_upstream_main_conf_t>
{
public:
	typedef NgxModule<void,ngx_http_upstream_srv_conf_t,ngx_http_upstream_main_conf_t> super_type;
